...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        CellPadding="12" DataSourceID="sds_ordersDetailed" ForeColor="Black" 
    ...
    <asp:SqlDataSource ID="sds_ordersDetailed" runat="server" ConnectionString="<%$ ConnectionStrings:CarConnection %>" DeleteCommand="DELETE FROM [orders] WHERE [id] = @id" 
