...
namespace Pages
{
    public partial class Pages_OrdersDetailed : System.Web.UI.Page
    {
        ...
        private void SendEmail(string client, string email, ArrayList orderList)
        {
            ...
            MailAddress from = new MailAddress("sanjidaahmed45@yahoo.com");
...
Kind regards
Sanjeeda Ahmed", client, Request.QueryString["date"], GenerateOrderedItems(orderList));
            ...
            smtp.Credentials = new NetworkCredential("sanjidaahmed45@yahoo.com", "01819253051");
            smtp.EnableSsl = true;
