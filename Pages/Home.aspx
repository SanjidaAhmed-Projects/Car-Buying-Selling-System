...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <img id="Img3" runat="server" src="~/Images/car.jpg" alt="" class="imgLeft" />
    <h3>Title 1</h3>
    <p>
    ...
    <img id="Img2" runat="server" src="~/Images/in.jpg" alt="" class="imgRight" />
    <h3>Title 2</h3>
    <p>
    ...
    <img id="Img1" runat="server" src="~/Images/stylish.png" alt="" class="imgLeft" />
    <h3>Title 3</h3>
    <p>
